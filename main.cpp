...
bool handle_fun1(const std::string& url, const std::string& body,
...
bool hello(const std::string& url, const std::string& body, mg_connection* c,
...
bool sum(const std::string& url, const std::string& body, mg_connection* c,
         OnRspCallback rsp_callback) {
  std::cout << "handle fun1" << std::endl;
  std::cout << "url: " << url << std::endl;
  std::cout << "body: " << body << std::endl;
...
bool handle_fun2(const std::string& url, const std::string& body,
                 mg_connection* c, OnRspCallback rsp_callback) {
