...
/* Amalgamated: #include "mongoose/cs_dbg.h" */
...
/* Amalgamated: #include "mongoose/cs_time.h" */
...
/* Amalgamated: #include "mongoose/base64.h" */
...
/* Amalgamated: #include "mongoose/cs_dirent.h" */
...
/* Amalgamated: #include "mongoose/md5.h" */
/* Amalgamated: #include "mongoose/str_util.h" */

#if !defined(EXCLUDE_COMMON)
#if !DISABLE_MD5

/* Amalgamated: #include "mongoose/cs_endian.h" */
...
#ifdef MG_MODULE_LINES
#line 1 "mongoose/sha1.c"
#endif
/* Copyright(c) By Steve Reid <steve@edmweb.com> */
/* 100% Public Domain */

/* Amalgamated: #include "mongoose/sha1.h" */
...
#define SHA1HANDSOFF
#if defined(__sun)
/* Amalgamated: #include "mongoose/solarisfixes.h" */
#endif
...
#ifdef MG_MODULE_LINES
#line 1 "mongoose/platforms/cc3200/cc3200_libc.c"
#endif
/*
 * Copyright (c) 2014-2016 Cesanta Software Limited
 * All rights reserved
...
#ifdef MG_MODULE_LINES
#line 1 "mongoose/platforms/msp432/msp432_libc.c"
#endif
/*
 * Copyright (c) 2014-2016 Cesanta Software Limited
 * All rights reserved
...
#ifdef MG_MODULE_LINES
#line 1 "mongoose/platforms/nrf5/nrf5_libc.c"
#endif
/*
 * Copyright (c) 2014-2016 Cesanta Software Limited
 * All rights reserved
...
#endif
#ifdef MG_MODULE_LINES
#line 1 "mongoose/platforms/simplelink/sl_fs_slfs.h"
#endif
/*
 * Copyright (c) 2014-2016 Cesanta Software Limited
 * All rights reserved
...
#ifdef MG_MODULE_LINES
#line 1 "mongoose/platforms/simplelink/sl_fs_slfs.c"
#endif
/*
 * Copyright (c) 2014-2016 Cesanta Software Limited
 * All rights reserved
...
/* Amalgamated: #include "mongoose/platforms/simplelink/sl_fs_slfs.h" */
...
#ifdef MG_MODULE_LINES
#line 1 "mongoose/platforms/simplelink/sl_fs.c"
#endif
/*
 * Copyright (c) 2014-2016 Cesanta Software Limited
 * All rights reserved
...
#ifdef MG_MODULE_LINES
#line 1 "mongoose/platforms/simplelink/sl_socket.c"
#endif
/*
 * Copyright (c) 2014-2016 Cesanta Software Limited
 * All rights reserved
...
#ifdef MG_MODULE_LINES
#line 1 "mongoose/platforms/simplelink/sl_mg_task.c"
#endif
...
void mg_run_in_task(void (*cb)(struct mg_mgr *mgr, void *arg), void *cb_arg) {
  ...
  osi_MsgQWrite(&s_mg_q, &msg, OSI_NO_WAIT);
          ...
          */
#ifdef MG_MODULE_LINES
#line 1 "mongoose/platforms/simplelink/sl_net_if.h"
#endif
/*
 * Copyright (c) 2014-2016 Cesanta Software Limited
 * All rights reserved
...
#ifdef MG_MODULE_LINES
#line 1 "mongoose/platforms/simplelink/sl_net_if.c"
#endif
/*
 * Copyright (c) 2014-2016 Cesanta Software Limited
 * All rights reserved
...
/* Amalgamated: #include "mongoose/platforms/simplelink/sl_net_if.h" */
...
#ifdef MG_MODULE_LINES
#line 1 "mongoose/platforms/simplelink/sl_ssl_if.c"
#endif
/*
 * Copyright (c) 2014-2016 Cesanta Software Limited
 * All rights reserved
...
#ifdef MG_MODULE_LINES
#line 1 "mongoose/platforms/lwip/mg_lwip_net_if.h"
#endif
/*
 * Copyright (c) 2014-2016 Cesanta Software Limited
 * All rights reserved
...
#ifdef MG_MODULE_LINES
#line 1 "mongoose/platforms/lwip/mg_lwip_net_if.c"
#endif
/*
 * Copyright (c) 2014-2016 Cesanta Software Limited
 * All rights reserved
...
#endif /* MG_ENABLE_NET_IF_LWIP_LOW_LEVEL */
#ifdef MG_MODULE_LINES
#line 1 "mongoose/platforms/lwip/mg_lwip_ev_mgr.c"
#endif
/*
 * Copyright (c) 2014-2016 Cesanta Software Limited
 * All rights reserved
...
#ifdef MG_MODULE_LINES
#line 1 "mongoose/platforms/lwip/mg_lwip_ssl_if.c"
#endif
/*
 * Copyright (c) 2014-2016 Cesanta Software Limited
 * All rights reserved
...
#ifdef MG_MODULE_LINES
#line 1 "mongoose/platforms/wince/wince_libc.c"
#endif
/*
 * Copyright (c) 2016 Cesanta Software Limited
 * All rights reserved
...
#endif
#ifdef MG_MODULE_LINES
#line 1 "mongoose/platforms/pic32/pic32_net_if.h"
#endif
/*
 * Copyright (c) 2014-2016 Cesanta Software Limited
 * All rights reserved
...
#ifdef MG_MODULE_LINES
#line 1 "mongoose/platforms/pic32/pic32_net_if.c"
#endif
/*
 * Copyright (c) 2014-2016 Cesanta Software Limited
 * All rights reserved
