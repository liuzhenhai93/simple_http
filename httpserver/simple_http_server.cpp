...
bool SimpleHttpServer::Start() {
  ...
  mg_connection *connection =
      mg_bind(&m_mgr_, m_port_.c_str(), SimpleHttpServer::OnHttpEvent);
...
void SimpleHttpServer::OnHttpEvent(mg_connection *connection, int event_type,
                                   void *event_data) {
  switch (event_type) {
...
void SimpleHttpServer::AddHandler(const std::string &url,
...
void SimpleHttpServer::SendHttpRsp(mg_connection *connection,
...
void SimpleHttpServer::HandleHttpEvent(mg_connection *connection,
...
void SimpleHttpServer::SendError(mg_connection *connection,
                                 const std::string &uri, int err_code,
